      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          <div className="col-span-1 md:col-span-1">
            ...
            <div className="flex space-x-4">
              <a href="#" className="text-gray-400 hover:text-boniean-orange transition-colors">
          ...
          <div className="col-span-1">
            ...
            <ul className="space-y-2">
              ...
              <li>
                <Link to="/clients" className="text-gray-400 hover:text-boniean-orange transition-colors">Our Clients</Link>
              </li>
              <li>
          ...
          <div className="col-span-1">
            ...
            <ul className="space-y-4">
              ...
              <li className="flex items-center">
                <Phone className="h-5 w-5 text-boniean-orange mr-3" />
        ...
        <div className="mt-12 pt-8 border-t border-boniean-orange/10 flex flex-col md:flex-row justify-between items-center">
          ...
          <div className="mt-4 md:mt-0 flex space-x-6">
            <a href="#" className="text-gray-400 hover:text-boniean-orange text-sm transition-colors">Privacy Policy</a>
            <a href="#" className="text-gray-400 hover:text-boniean-orange text-sm transition-colors">Terms of Service</a>
            <a href="#" className="text-gray-400 hover:text-boniean-orange text-sm transition-colors">Cookie Policy</a>
          </div>
        </div>
      </div>
    </footer>
