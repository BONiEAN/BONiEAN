...
export const Footer = () => {
  ...
  return (
    <footer className="relative overflow-hidden bg-[#17151a] border-t border-white/10">
      <div className="absolute inset-0 bg-[radial-gradient(circle_at_20%_0%,rgba(249,115,22,0.12),transparent_30%),radial-gradient(circle_at_90%_100%,rgba(254,198,161,0.08),transparent_28%)]" />
      <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-14">
        <div className="grid grid-cols-1 gap-8 rounded-[2rem] border border-white/10 bg-white/[0.035] p-8 shadow-2xl shadow-black/30 backdrop-blur-xl md:grid-cols-4">
          <div className="col-span-1 md:col-span-1">
            ...
            <div className="flex justify-center space-x-4">
              <a 
                ...
                className="rounded-full border border-white/10 bg-white/10 p-3 text-gray-300 transition-all duration-300 hover:-translate-y-0.5 hover:border-boniean-orange/50 hover:text-boniean-orange"
              >
        ...
        <div className="mt-10 pt-8 border-t border-white/10 flex flex-col md:flex-row justify-between items-center">
          ...
          <div className="mt-4 md:mt-0 flex flex-wrap justify-center gap-x-6 gap-y-3">
