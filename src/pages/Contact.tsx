      ...
      <main className="pt-24">
              ...
              <div>
                ...
                <div className="bg-boniean-dark-charcoal p-8 rounded-lg border border-boniean-orange/20">
                  <div className="space-y-6">
                    ...
                    <div className="flex items-start">
                      <div className="flex-shrink-0">
                        <Phone className="h-6 w-6 text-boniean-orange" />
                      </div>
                      <div className="ml-4">
        ...
        <section className="py-16 bg-boniean-dark-charcoal">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div className="h-96 bg-boniean-charcoal rounded-lg overflow-hidden border border-boniean-orange/20">
              {/* Replace with actual map embed */}
              <div className="w-full h-full bg-boniean-dark-charcoal flex items-center justify-center">
                <p className="text-gray-400">Map will be embedded here</p>
              </div>
            </div>
          </div>
        </section>
